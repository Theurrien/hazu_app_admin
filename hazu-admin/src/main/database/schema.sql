...
CREATE TABLE IF NOT EXISTS tag_mappings (
    ...
    category TEXT NOT NULL CHECK (category IN ('room_type', 'person_role')),
...
INSERT OR IGNORE INTO tag_mappings (tag, category, semantic_value, description) VALUES
    ...
    -- Person types (base patterns)
    ('hz-share-student', 'person_role', 'student', 'Student'),
    ('hz-share-companymentor', 'person_role', 'companymentor', 'Company mentor'),
    ('hz-share-schoolteacher', 'person_role', 'schoolteacher', 'School teacher'),
    ('hz-share-courseteacher', 'person_role', 'courseteacher', 'Course teacher'),
    ('hz-share-stateadvisor', 'person_role', 'stateadvisor', 'State advisor'),
    ('hz-share-guardian', 'person_role', 'guardian', 'Parent/Guardian');
